...
/**
 * Class IntegerNet_SolrPro_Helper_Timage
 *
 * Taken from https://github.com/dbashyal/Magento-resize-category-images
 */
class IntegerNet_SolrPro_Helper_Timage extends Mage_Core_Helper_Abstract
{
     ...
     * @return IntegerNet_SolrPro_Helper_Timage
     */
    ...
    {
        $cache = BP . DS . 'media' . DS . 'integernet_solr' . DS . 'cache' . DS;
