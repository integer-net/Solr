...
class IntegerNet_SolrPro_Model_Cms_Result
{
    /**
    ...
    {
        $this->_solrRequest = Mage::helper('integernet_solrpro')->factory()->getSolrRequest(SolrRequestFactory::REQUEST_MODE_CMS_PAGE);
    }
